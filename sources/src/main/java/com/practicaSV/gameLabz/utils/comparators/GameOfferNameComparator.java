...
public class GameOfferNameComparator extends GameOfferComparator {
    @Override
    public int compare(GameOffer o1, GameOffer o2) {
        ...
        int result = o1.getGames().stream().findFirst().get().getName().compareToIgnoreCase(o2.getGames().stream().findFirst().get().getName());
